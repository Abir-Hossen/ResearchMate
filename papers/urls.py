...
from .views import (
    delete_paper_view,
    download_beginner_pdf,
    download_glossary_pdf,
    download_revision_notes_pdf,
    download_technical_pdf,
    download_viva_pdf,
    my_papers_view,
    paper_beginner,
    paper_flashcards,
...
urlpatterns = [
    ...
    path('<int:paper_id>/beginner/download/', download_beginner_pdf, name='paper_beginner_download'),
    path('<int:paper_id>/technical/', paper_technical, name='paper_technical'),
    path('<int:paper_id>/technical/download/', download_technical_pdf, name='paper_technical_download'),
    ...
    path('<int:paper_id>/glossary/download/', download_glossary_pdf, name='paper_glossary_download'),
    ...
    path('<int:paper_id>/viva/download/', download_viva_pdf, name='paper_viva_download'),
    path('<int:paper_id>/notes/', paper_notes, name='paper_notes'),
    path('<int:paper_id>/notes/download/', download_revision_notes_pdf, name='paper_notes_download'),
